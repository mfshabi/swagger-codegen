...
> \Swagger\Client\Model\InlineResponse20052 reportsByZoneVodPullBrowsers($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20055 reportsByZoneVodPullCache($x_api_key, $zoneid, $frequency, $filter_type, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20051 reportsByZoneVodPullCountries($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20053 reportsByZoneVodPullOs($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20050 reportsByZoneVodPullStatuscodes($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20056 reportsByZoneVodPullTopfiles($x_api_key, $zoneid, $start_date, $end_date, $type)
...
> \Swagger\Client\Model\InlineResponse20057 reportsByZoneVodPullTopreferrers($x_api_key, $zoneid, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20054 reportsByZoneVodPullVisitors($x_api_key, $zoneid, $frequency, $start_date, $end_date)
