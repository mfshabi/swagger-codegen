...
> \Swagger\Client\Model\InlineResponse20053 reportsByZoneVodPushBrowsers($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20056 reportsByZoneVodPushCache($x_api_key, $zoneid, $frequency, $filter_type, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20052 reportsByZoneVodPushCountries($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20054 reportsByZoneVodPushOs($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20051 reportsByZoneVodPushStatuscodes($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20057 reportsByZoneVodPushTopfiles($x_api_key, $zoneid, $start_date, $end_date, $type)
...
> \Swagger\Client\Model\InlineResponse20050 reportsByZoneVodPushTopreferrers($x_api_key, $zoneid, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20055 reportsByZoneVodPushVisitors($x_api_key, $zoneid, $frequency, $start_date, $end_date)
