...
> \Swagger\Client\Model\InlineResponse20053 reportsByZoneRecordCache($x_api_key, $zoneid, $frequency, $filter_type, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20056 reportsByZoneRecordCountries($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20055 reportsByZoneRecordStatuscodes($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20054 reportsByZoneRecordTopreferrers($x_api_key, $zoneid, $start_date, $end_date)
