...
> \Swagger\Client\Model\InlineResponse20053 reportsByZoneRecordBrowsers($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20056 reportsByZoneRecordCache($x_api_key, $zoneid, $frequency, $filter_type, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20052 reportsByZoneRecordCountries($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20054 reportsByZoneRecordOs($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20051 reportsByZoneRecordStatuscodes($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20049 reportsByZoneRecordTopfiles($x_api_key, $zoneid, $start_date, $end_date, $type)
...
> \Swagger\Client\Model\InlineResponse20050 reportsByZoneRecordTopreferrers($x_api_key, $zoneid, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20055 reportsByZoneRecordVisitors($x_api_key, $zoneid, $frequency, $start_date, $end_date)
