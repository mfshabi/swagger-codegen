...
> \Swagger\Client\Model\InlineResponse20051 reportsByZonePushBrowsers($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20050 reportsByZonePushCountries($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
# **reportsByZonePushOs**
> \Swagger\Client\Model\InlineResponse20052 reportsByZonePushOs($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20049 reportsByZonePushStatusCode($x_api_key, $zoneid, $frequency, $start_date, $end_date)
...
> \Swagger\Client\Model\InlineResponse20053 reportsByZonePushVisitors($x_api_key, $zoneid, $frequency, $start_date, $end_date)
