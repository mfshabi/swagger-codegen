...
/**
 * PostRecordServers Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostRecordServers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostRecordServers';
...
'audioonly' => 'getAudioonly'    ];
     ...
     * Sets server
     *
     * @param string $server server.code should be one of the server code from the GET /streams/record/servers call.
     *
     * @return $this
     */
