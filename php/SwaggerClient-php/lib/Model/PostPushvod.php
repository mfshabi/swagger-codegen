 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostPushvod implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostPushvod';
...
'ssl' => 'getSsl'    ];
     ...
     * Sets server
     *
     * @param string $server server.code, Should be one of the server code from the GET zones/vod/push/servers call
     *
     * @return $this
     */
