...
/**
 * PostPullzone Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostPullzone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostPullzone';
...
'ssl' => 'getSsl'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cache_expiry'] = isset($data['cache_expiry']) ? $data['cache_expiry'] : null;
    ...
    {
        return $this->container['cache_expiry'];
    }

    /**
     * Sets cache_expiry
     *
     * @param string $cache_expiry This will be the default cache name.The values can be 1d,7d,14d, 1M, 3M, 6M, or 1y
     *
     * @return $this
     */
    public function setCacheExpiry($cache_expiry)
    {
        $this->container['cache_expiry'] = $cache_expiry;
