...
/**
 * Puttimeshift Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Puttimeshift implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Puttimeshift';
...
'audioonly' => 'getAudioonly'    ];
     ...
     * Sets timeshift
     *
     * @param int $timeshift Timeshift in seconds, by which the recorded streams should be shifted.
     *
     * @return $this
     */
